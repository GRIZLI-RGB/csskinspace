	...
	return (
		<>
			...
			<Text center className="mt-2 mb-16">
				...
				<br />
				This Cookies Policy explains how <b>CSSKINSPACE</b> (operated by{" "}
				<b>PLAY SPACE TECH LTD, “we”, “our”, or “us”</b>) uses cookies
			...
			<div className="flex flex-col gap-6">
					...
					text={[
						<>
							...
							<ul className="list-disc pl-8 mt-2">
								<li>
									Session cookies – temporary, deleted when
								...
								<li>
									First-party cookies – placed by CSSKINSPACE
								</li>
								<li>
									Third-party cookies – placed by external
									services (e.g., analytics)
								</li>
							</ul>
						</>,
				...
				<BuildBlock
					...
					text={[
						<>
							...
							<ul className="list-disc pl-8 mt-2">
								<li>
									Ensure the website functions properly (e.g.,
									login, navigation)
								</li>
								<li>Maintain your session across pages</li>
								<li>Prevent fraudulent behavior or abuse</li>
								<li>
									Understand how users interact with the site
									(e.g., page visits, bounce rate)
								</li>
								<li>
									Store preferences (language, currency, etc.)
								</li>
							</ul>
							We do not use cookies to collect sensitive personal
							information without your consent.
				...
				<BuildBlock
					...
					text={[
						<>
							...
							<ul className="list-disc pl-8 mt-2">
								<li>
									Google Analytics – to understand user
									behavior and improve our platform
								</li>
								<li>
									Payment providers – to handle secure
									transactions and fraud prevention
								</li>
								<li>
									Marketing platforms (if activated) – to
									analyze promotions or campaigns
								</li>
							</ul>
							These third parties may set their own cookies in
				...
				<BuildBlock
					...
					text={[
						<>
							When you visit our site for the first time, you will
							see a cookie banner requesting your consent to use
							optional cookies (e.g., analytics, marketing). You
							can:
							<ul className="list-disc pl-8 mt-2">
							...
							You can also manage your preferences later via
							browser settings.
							<p className="mt-2 font-semibold text-red-600">
								⚠️ Disabling essential cookies may impact the
				...
				<BuildBlock
					...
					text={[
						<>
							We may update this Cookies Policy from time to time.
							Any changes will be posted on this page, and the
							“Effective Date” will be updated. Continued use of
							the website implies acceptance of the revised
							policy.
						</>,
					]}
				/>
